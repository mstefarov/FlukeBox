...
namespace TagLib {
	...
	public abstract class File : IDisposable
	{
		...
		public delegate File FileCreator(IFileAbstraction abstraction, ReadStyle style);
		#endregion
		                           ...
		                           ReadStyle propertiesStyle)
		{
			...
			if (!FileTypes.IsRecognized(mimetype))
			...
			File newFile = FileTypes.CreateFileForMimeType(mimetype, abstraction, propertiesStyle);
